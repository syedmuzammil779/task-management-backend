...
describe("getAllTasks", () => {
  ...
  it("should return tasks and success response", async () => {
  ...
  it("should return task by category if tasks exist of that category", async () => {
    taskFakeData.id = 1;
...
describe("createTask", () => {
  test("should return success if correct body is passed to create a task", async () => {
    const req = {
      body: taskFakeData,
    };
  ...
  test("should return error if task insertion fail to return correct response", async () => {
    const req = {
      body: taskFakeData,
    };
  ...
  test("should return internal server error if task insertion fails.", async () => {
    const req = {
      body: taskFakeData,
    };
